...
{
    [DataContract]
    public partial class CompetitorSource : Record
    {
        #region Public Constructors

        public CompetitorSource() : base() { }
        ...
        [DataMember]
        public int CompetitorSourceId { get { return Utilities.ToInt(RecordId); } set { RecordId = value; RaisePropertyChanged("CompetitorSourceId"); } }
